// scratch/fix_all_inflated_players.js
...
async function main() {
    ...
    console.log('--- Finding players with multiple divisions ---');
    ...
    console.log(`\nSuccessfully corrected stats for ${fixCount} players in the database.`);
    process.exit(0);
}
