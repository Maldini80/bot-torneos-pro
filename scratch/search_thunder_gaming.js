// scratch/search_thunder_gaming.js
import 'dotenv/config';

const EA_HEADERS = {
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, where Gecko) Chrome/119.0.0.0 Safari/537.36",
